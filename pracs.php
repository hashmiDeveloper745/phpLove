...
<body>
  <div class="firstDiv">
  <h2 id="heading">Supplied directly pleasant we ignorant ecstatic of jointure so if</h2>
...
<div id="secondDiv">
<h2>You disposal strongly quitting his endeavor two settling him</h2>
